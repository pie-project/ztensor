...
## Reproducing LEADING/Website Figures

The figures in the [README](../README.md) and [website](../website/) are generated by a standalone script that ensures consistent styling and output for the documentation.
...
2. Manually update the `CROSS_FORMAT_DATA` and `WRITE_DIST_DATA` lists in `../scripts/generate_readme_charts.py` with the median values from your results.
